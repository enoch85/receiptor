/**
 * Login Page
 * Handles authentication with email/password, OAuth, and BankID
 */
...
import { signIn, signInWithOAuth, signInWithBankID } from '@/lib/auth';
...
export default function LoginPage() {
  ...
  const handleBankIDSignIn = async (country: 'se' | 'no' | 'dk') => {
    setError(null);
    setLoading(true);
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to your Receiptor account
          </p>
        </div>
        ...
        {/* BankID Section (Nordic Countries) */}
        <div className="space-y-3">
          <p className="text-xs text-center text-gray-500 uppercase tracking-wide font-semibold">
            🇸🇪 🇳🇴 🇩🇰 Nordic Authentication
          </p>

          <button
            onClick={() => handleBankIDSignIn('se')}
            disabled={loading}
